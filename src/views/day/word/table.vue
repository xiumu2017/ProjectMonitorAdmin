<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="单词" min-width="20%">
        <template slot-scope="scope">
          <p>{{ scope.row.word }}</p>
          <audio controls="controls" :src="'https://dict.youdao.com/dictvoice?type=0&audio=' + scope.row.word">美</audio>
          <audio controls="controls" :src="'https://dict.youdao.com/dictvoice?type=1&audio=' + scope.row.word">英</audio>
        </template>
      </el-table-column>
      <el-table-column label="例句" min-width="50%">
        <template slot-scope="scope">
          <p>{{ scope.row.sentence }}</p>
          <audio controls="controls" :src="'https://dict.youdao.com/dictvoice?type=0&audio=' + scope.row.sentence">美</audio>
          <audio controls="controls" :src="'https://dict.youdao.com/dictvoice?type=1&audio=' + scope.row.sentence">英</audio>
        </template>
      </el-table-column>
...
import { getPage, del, update } from '@/api/day/word'
