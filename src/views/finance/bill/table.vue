<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="方向" min-width="10%">
        <template slot-scope="scope">
          {{ directionArr[scope.row.direction] }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="账单名称" min-width="10%">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
...
import { getPage, del, update, excelExport } from '@/api/finance/bill'
