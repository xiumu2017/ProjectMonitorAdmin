<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="购买时间" width="150px">
        <template slot-scope="scope">
          {{ scope.row.purchaseTime }}
        </template>
      </el-table-column>
      <el-table-column label="来源" width="150px">
        <template slot-scope="scope">
          {{ scope.row.source }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="明细" width="300px">
        <template slot-scope="scope">
      ...
      <el-table-column label="链接" width="150px">
        <template slot-scope="scope">
          <a :href="scope.row.orderLink" class="el-icon-share" target="_blank" style="color: #409EFF">link</a>
        </template>
      </el-table-column>
...
import { getPage, del, update, payTypes, sources, excelExport } from '@/api/finance/shopping'
