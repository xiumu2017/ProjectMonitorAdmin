<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" size="mini" type="primary" @click="excelExport">导出
      </el-button>
      <el-upload
        class="upload-demo"
        action=""
    ...
    >
      ...
      <el-table-column label="原始名称" min-width="10%">
        <template slot-scope="scope">
          {{ scope.row.fileName }}
        </template>
      </el-table-column>
      <el-table-column label="封面" min-width="10%">
        <template slot-scope="scope">
          <el-image style="width: 192px; height: 108px" :src="scope.row.url + '?imageView2/1/w/384/h/216/q/40'" />
        </template>
      </el-table-column>
      <el-table-column label="大小" min-width="5%">
        <template slot-scope="scope">
          {{ scope.row.size }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="更多信息" min-width="25%">
        <template slot-scope="scope">
          {{ scope.row.infoJson }}
        </template>
      </el-table-column>
...
import { getPage, del, update, create } from '@/api/day/photo'
